...
import LocationService from './LocateParcel';
...
class HomeContainer extends Component {
    ...
    checkPermissions = async () => {
        ...
        if (hasPermission) {
            if (Capacitor.isNative) {
                ...
                await this.postGPSPermission(canUseGPS);
            }
            else {
                await this.postGPSPermission(true);
            }
        }
        else {
            console.log('14');
    ...
    watchPosition = async () => {
        try {
            ...
            this.watchId = Geolocation.watchPosition({}, (position: { coords: { latitude: any; longitude: any; }; }, err: any) => {
